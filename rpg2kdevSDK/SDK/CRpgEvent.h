...
public:
	/// イベントパーツプライオリティ
	enum DrawPriority {
		kDrawPriorityLow,		///< 0:通常キャラの下
		kDrawPriorityNormal,	///< 1:通常キャラと重ならない
		kDrawPriorityHigh,		///< 2:通常キャラの上
	};

public:
	CRpgMapEvent(): x(0), y(0){}		///< デフォルトコンストラクタ
	...
	smart_array< Page > saPage;	///< 0x05:マップイベント
